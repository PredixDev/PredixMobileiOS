...
+ (id _Nonnull (^ _Nonnull)(NSString * _Nonnull))createKey SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
+ (id <LoggerProtocol> _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
+ (BOOL)automaticallyListenForApplicationStateEvents SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)authenticationScheme SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)loginURLPath SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)logoutURLPath SWIFT_WARN_UNUSED_RESULT;
...
+ (enum ConfigurationLocation)pmappDocumentNameConfigLocation SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)seriousErrorDefaultMessage SWIFT_WARN_UNUSED_RESULT;
...
+ (void (^ _Nullable)(SWIFT_NOESCAPE void (^ _Nonnull)(void)))additionalBootRestartWorkflow SWIFT_WARN_UNUSED_RESULT;
...
+ (NSArray<Class <ServiceProtocol>> * _Nullable)additionalBootServicesToRegister SWIFT_WARN_UNUSED_RESULT;
...
+ (NSDictionary<NSString *, id> * _Nullable)remoteNotificationRegistrationAdditionalInfo SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)remoteNotificationRegistrationDocumentId SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)remoteNotificationRegistrationDocumentType SWIFT_WARN_UNUSED_RESULT;
...
+ (NSDictionary<NSString *, id> * _Nullable)replicationAdditionalPushSettings SWIFT_WARN_UNUSED_RESULT;
...
+ (NSDictionary<NSString *, id> * _Nullable)replicationAdditionalPullSettings SWIFT_WARN_UNUSED_RESULT;
...
+ (NSInteger)replicationFailureMaxRetryAttempts SWIFT_WARN_UNUSED_RESULT;
...
+ (NSTimeInterval)replicationFailureRetryRecoveryTime SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nullable)defaultPushReplicationFilterName SWIFT_WARN_UNUSED_RESULT;
...
+ (NSDictionary<NSString *, id> * _Nullable)defaultPushReplicationFilterParameters SWIFT_WARN_UNUSED_RESULT;
...
+ (NSArray<NSString *> * _Nullable)defaultPullReplicationChannels SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nullable)keychainAccessGroup SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)keychainKeyPrefix SWIFT_WARN_UNUSED_RESULT;
...
+ (BOOL)considerUIReadyWhenApplicationDidBecomeActive SWIFT_WARN_UNUSED_RESULT;
...
+ (void (^ _Nonnull)(NSString * _Nonnull, void (^ _Nonnull)(void)))displaySeriousErrorPopup SWIFT_WARN_UNUSED_RESULT;
...
+ (NSURL * _Nonnull)localStorageURL SWIFT_WARN_UNUSED_RESULT;
...
+ (NSURL * _Nullable)userLocalStorageURL SWIFT_WARN_UNUSED_RESULT;
...
/// If a directory named <code>hybridUIDatabaseName</code>.cblite2 containing a sql lite database exists in the application bundle, then this database will be used as an inital data source.
...
///
/// \endcode
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nullable hybridUIDatabaseName;)
+ (NSString * _Nullable)hybridUIDatabaseName SWIFT_WARN_UNUSED_RESULT;
+ (void)setHybridUIDatabaseName:(NSString * _Nullable)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull hybridUIDatabaseNameConfigKey;)
+ (NSString * _Nonnull)hybridUIDatabaseNameConfigKey SWIFT_WARN_UNUSED_RESULT;
+ (void)setHybridUIDatabaseNameConfigKey:(NSString * _Nonnull)value;
/// Specifies where the hybrid UI database name configuration key/value should be found.
/// <em>Default</em>: Info.plist
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum ConfigurationLocation hybridUIDatabaseNameConfigLocation;)
+ (enum ConfigurationLocation)hybridUIDatabaseNameConfigLocation SWIFT_WARN_UNUSED_RESULT;
+ (void)setHybridUIDatabaseNameConfigLocation:(enum ConfigurationLocation)value;
/// Works with <code>hybridUIDatabaseName</code> to allow the hybrid UI web elements to be updated dynamically.
...
/// <em>Behaviors:</em>
/// <em>true</em>: On application start, the database named in <code>PredixMobilityConfiguration.hybridUIDatabaseName</code> will be refreshed from the backend sync gateway. Application loading will wait until this database has synced, but will not wait for the main data database to sync.
/// <em>false</em>: No replication will be performed to update the <code>hybridUIDatabaseName</code> database. This database is expected to be included in the application bundle. Application loading will not wait for the main data database to sync.
/// attention:
/// Must be <em>false</em> for any App Store production system.
/// <em>Default</em>: true
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL hybridUIAllowUpdates;)
+ (BOOL)hybridUIAllowUpdates SWIFT_WARN_UNUSED_RESULT;
+ (void)setHybridUIAllowUpdates:(BOOL)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull hybridUIAllowUpdatesConfigKey;)
+ (NSString * _Nonnull)hybridUIAllowUpdatesConfigKey SWIFT_WARN_UNUSED_RESULT;
+ (void)setHybridUIAllowUpdatesConfigKey:(NSString * _Nonnull)value;
...
+ (NSDictionary<NSString *, NSString *> * _Nonnull)getVersionInfo SWIFT_WARN_UNUSED_RESULT;
...
+ (PredixMobilityManager * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
...
+ (id <ServiceRouterProtocol> _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
/// Registers the provided service class.
/// \param service class type meeting the ServiceProtocol type.
///
